    ...
    >
      <div className="absolute z-10 w-2/3 pt-20 md:text-lg lg:pl-20 2xl:pl-32 ">
        ...
        <p className="pt-4 text-lg font-medium lg:text-xl">
          ...
          expertly handmade in-house, using only the freshest local ingredients.
          Our buns are artisanally baked each morning. Our fixings are local and
          organic. Every burger is prepared fresh to-order and made with love.
        </p>
      </div>
