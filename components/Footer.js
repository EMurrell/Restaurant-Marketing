    ...
    <footer className="bg-white" aria-labelledby="footer-heading" id="Contact">
      ...
      <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:py-16 lg:px-8 font-body">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="grid grid-cols-2 gap-16 mt-12 xl:mt-0 xl:col-span-2 md:pl-32">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="mt-4 space-y-4">
                  <li>Monday: 11-8</li>
                  <li>Tuesday: 11-9</li>
                  <li>Wednesday: 11-9</li>
                  <li>Thursday: 11-10</li>
                  <li>Friday: 11-11</li>
                  <li>Saturday: 11-11</li>
                  <li>Sunday: Closed</li>
                </ul>
              </div>
            </div>
