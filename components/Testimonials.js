            ...
            <div className="max-w-md px-4 mx-auto sm:max-w-2xl sm:px-6 lg:px-0 lg:py-20 lg:max-w-none">
              <blockquote>
                <div>
                  ...
                  <p className="mt-6 text-2xl font-medium text-white font-body">
                    ...These burgers are so unbelievably good, every ingredient
                    so incredibly fresh. I'll never eat a burger anywhere else.
                    My standards are now too high.
                  </p>
                </div>
                <footer className="mt-6">
                  <p className="text-base font-medium text-white">Joe Foody</p>
